			...
			<tr>
				<td height="30" colspan="4" align="center">
					<input type="button" value="글수정" 
						onclick="location.href='${root}/fileBoard/update.do?boardNumber=${boardDto.boardNumber}&pageNumber=${pageNumber}'"/>
								
					<input type="button" value="글삭제" 
						onclick="location.href='${root}/fileBoard/delete.do?boardNumber=${boardDto.boardNumber}&pageNumber=${pageNumber}'"/>
